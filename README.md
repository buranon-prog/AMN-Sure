...
| Data Warehouse | `/data-warehouse` | Export ข้อมูลทุกตารางเป็นไฟล์ CSV (กรองตามสิทธิ์ที่มี) |

นอกจากนี้ในโมดูล HR ยังมี:

- **แผนงานพนักงาน** (`/hr/planning`) — ตั้งแผนงาน/เป้าหมายของพนักงานแต่ละคนต่อรอบเวลา แยกจาก KPI
  (KPI คือผลลัพธ์จริงเทียบเป้าหมาย ส่วนแผนงานคือสิ่งที่ควรทำ)
- **รายงานพนักงาน** (`/hr/reports`) — สรุปผลการทำงานรายคน (การมาทำงาน, KPI เฉลี่ย, แผนงานค้าง/เสร็จแล้ว)
  พร้อมหน้ารายงานฉบับเต็มต่อคนและปุ่ม export CSV
...
หน้า Data Warehouse ใช้ตัวข้อมูลเดียวกับทุกโมดูล (ไม่มีการ sync/ETL แยก) — ทุกอย่างที่บันทึกในระบบ
จะพร้อม export ได้ทันที และการมองเห็นรายการ export แต่ละตารางจะอิงสิทธิ์ต่อโมดูลเดียวกับหน้าเว็บปกติ
